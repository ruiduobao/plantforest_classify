...
# 天然林样本点数据文件路径
POINTS_FILE = r"D:\地理所\论文\东南亚10m人工林提取\数据\验证点数据\交叉验证集\1.人工林样本点\3.根据栅格数据进行补充\plantation_sample_points_20251010_182215.gpkg"  # 指定点数据路径
# 输出目录路径
OUTPUT_DIR = r"D:\地理所\论文\东南亚10m人工林提取\数据\验证点数据\交叉验证集\1.人工林样本点\3.根据栅格数据进行补充"  # 指定输出目录
# 随机种子（保证结果可重现）

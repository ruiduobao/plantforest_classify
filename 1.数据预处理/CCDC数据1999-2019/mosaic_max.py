...
def main():
    ...
    """
    # 定义路径
    input_dir = r"D:\地理所\论文\东南亚10m人工林提取\数据\CCDC_1999-2019\tBreak_max"
    output_dir = r"D:\地理所\论文\东南亚10m人工林提取\数据\CCDC_1999-2019"
    output_file = os.path.join(output_dir, "tBreak_max_mosaic.tif")

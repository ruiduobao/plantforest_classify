...
def main():
    ...
    """
    # 配置参数
    EXCEL_PATH = r"D:\地理所\论文\东南亚10m人工林提取\数据\正式分类_10.29\3.GEE导出结果_结果合并_马尔可夫模型\zone7\1.统计人工林和自然林的变化情况_变化检测分类\land_use_transition_matrices_20251030_172502.xlsx"
    OUTPUT_DIR = r"D:\地理所\论文\东南亚10m人工林提取\数据\正式分类_10.29\3.GEE导出结果_结果合并_马尔可夫模型\zone7\桑基图"

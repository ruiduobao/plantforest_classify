...
def main():
    ...
    """
    # 配置参数
    BASE_DATA_DIR = r"D:\地理所\论文\东南亚10m人工林提取\数据\正式分类_10.29\3.GEE导出结果_结果合并_马尔可夫模型\zone7"  # 分类结果基础目录
    OUTPUT_DIR = r"D:\地理所\论文\东南亚10m人工林提取\数据\正式分类_10.29\3.GEE导出结果_结果合并_马尔可夫模型\zone7\1.统计人工林和自然林的变化情况_变化检测分类"  # 输出目录
    YEARS = list(range(2017, 2025))  # 2017-2024年
    CATEGORIES = [1, 2, 3]  # 人工林(1), 自然林(2), 其他(3)
    FILE_PATTERN = "optimized_zone7_*_添加颜色映射表.tif"  # 文件匹配模式，匹配合并后的分类结果

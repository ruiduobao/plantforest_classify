...
# 天然林样本点数据文件路径
POINTS_FILE = r"D:\地理所\论文\东南亚10m人工林提取\数据\验证点数据\交叉验证集\3.自然林样本点\2.筛选自然林样本点\natural_forest_points_selected_20251010_180425.gpkg"  # 指定点数据路径
# 输出目录路径
OUTPUT_DIR = r"D:\地理所\论文\东南亚10m人工林提取\数据\验证点数据\交叉验证集\3.自然林样本点\3.随机抽样"  # 指定输出目录
# 随机种子（保证结果可重现）
...
def setup_logging(output_dir):  # 定义日志设置函数
    ...
    log_file = os.path.join(output_dir, f"grid_sampling_{timestamp}.log")  # 构造日志文件路径
